...
public class DBService {
	...
	public void instatiateTestDatabase() throws ParseException {
			...
			Produto p7 = new Produto(null,"TV Color",1880.00);
			Produto p8 = new Produto(null,"Roçadeira",180.00);
			Produto p9 = new Produto(null,"Abajour",100.00);
			Produto p10 = new Produto(null,"Pendente",120.00);
			Produto p11 = new Produto(null,"Shampoo",15.00);
...
//			--------------------------------------------------
			...
			Cliente cli1 = new Cliente(null,"Maria Silva","maria@gmail.com","99999999999",TipoCliente.PESSOAFISICA, encoder.encode("123"));
